...
var NAMESPACE = 'ionic-datepicker';
var scopeId;
var hostTagName;
var isSvgMode = false;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, import('./shadow-css-76400429.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 3:
                style_1 = _a.sent();
                _a.label = 4;
            case 4:
...
var flush = function () {
    ...
    var timeout = (plt.$flags$ & 6 /* queueMask */) === 2 /* appLoaded */ ? performance.now() + 10 * Math.ceil(queueCongestion * (1.0 / 22.0)) : Infinity;
    // DOM WRITES!!!
...
var patchEsm = function () {
    ...
    if (!(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-f8adc4ba.js').then(function () {
...
var patchBrowser = function () {
    ...
    }
    {
        ...
        if (!win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-4001f04a.js').then(function () { return opts; });
        }
    }
