...
const IonicDatepickerPopover = class {
    ...
    async onSelect(instance) {
        await document.querySelector('ion-popover').dismiss({ date: instance.dateSelected ? utils.toISODate(instance.dateSelected.toISOString()) : null });
    }
    render() {
